        ...
        <md-card-content>
          ...
          >
            ...
            <md-table-row slot="md-table-row" slot-scope="{ item }">
              ...
              <md-table-cell md-label="Symbol" md-sort-by="symbol">{{
                item.symbol
              }}</md-table-cell>
              <md-table-cell md-label="Total Supply">{{ item.totalSupply }}</md-table-cell>
...
export default {
  ...
  created () {
            ...
            var app=this;
                axios.get("http://localhost:3201/api/ecash",{headers:{'x-access-token': token}})
                    .then((response) => {
  ...
  data() {
    ...
    //   footerTable: ["Name", "Date", "Received", "Sent", "Actions"],
      searchQuery: "",
      propsToSearch: ["name", "symbol", "totalSupply"],
      tableData: [],
       transactName:[],
      searchedData: [],
      fuseSearch: null
  ...
  handleEdit(edittoken) {
     let path1='/token/'+edittoken
