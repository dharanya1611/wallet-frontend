  ...
  >
    ...
    >
      ...
      <template slot="links">
        ...
        <sidebar-item
          v-if="$route.meta.rtlActive"
          :link="{ name: 'التقويم', icon: 'date_range', path: '/userDetails' }"
        ></sidebar-item>
        <sidebar-item
          v-else
          :link="{ name: 'Wallet Users', icon: 'date_range', path: '/userDetails' }"
        ></sidebar-item>
        <sidebar-item
          v-if="$route.meta.rtlActive"
          :link="{ name: 'التقويم', icon: 'date_range', path: '/userDetails' }"
        ...
        <sidebar-item
          v-else
          :link="{ name: 'Company Management', icon: 'date_range', path: '/companyList' }"
        ></sidebar-item>
        <sidebar-item
          v-if="$route.meta.rtlActive"
          :link="{ name: 'التقويم', icon: 'date_range', path: '/companyList' }"
        ></sidebar-item>
        <sidebar-item
          v-else
          :link="{ name: 'E-Cash Tokens', icon: 'date_range', path: '/ecash' }"
        ></sidebar-item>
        <sidebar-item
          v-if="$route.meta.rtlActive"
          :link="{ name: 'التقويم', icon: 'date_range', path: '/ecash' }"
        ></sidebar-item>
        <sidebar-item
          v-else
          :link="{ name: 'Card Users', icon: 'date_range', path: '/card' }"
        ></sidebar-item>
         <sidebar-item
          v-if="$route.meta.rtlActive"
          :link="{ name: 'التقويم', icon: 'date_range', path: '/card' }"
        ></sidebar-item>
