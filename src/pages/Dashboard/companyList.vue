        ...
        <md-card-content>
          ...
          >
            ...
            <md-table-row slot="md-table-row" slot-scope="{ item }">
              ...
              <md-table-cell md-label="Reg No">{{ item.companyCrn }}</md-table-cell>
...
export default {
  ...
  created () {
            ...
            var app=this;
                axios.get("http://localhost:3201/api/companyList",{headers:{'x-access-token': token}})
                    .then((response) => {
  ...
  handleEdit(edituser) {
     let path1='/editcompany/'+edituser
